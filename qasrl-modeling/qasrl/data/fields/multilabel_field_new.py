...
# TODO: this is fixed from AllenNLP and should be contributed back.

class MultiLabelField_New(Field[torch.Tensor]):
    """
    ...
    def empty_field(self):
        return MultiLabelField_New([], self._label_namespace, skip_indexing = self._num_labels is not None, num_labels = self._num_labels)
